...
func _add_extra_controls() -> void:
	...
	debug_toggle_button.toggle_mode = true
	debug_toggle_button.flat = true
	debug_toggle_button.modulate = Color(0.75, 0.75, 0.75)
	debug_toggle_button.add_theme_font_size_override("font_size", DEBUG_CONTROL_FONT_SIZE)
	debug_toggle_button.toggled.connect(_on_debug_toggle_changed)
	...
	debug_controls.append(loss_test_button)
	...
	debug_controls.append(phase7_run_button)
...
func _on_debug_toggle_changed(is_pressed: bool) -> void:
	_set_debug_controls_visible(is_pressed)
