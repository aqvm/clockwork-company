...
- `clockwork-company/scripts/tools/content_validation_check.gd` owns repository content sanity checks for scenarios, scenario rules, scenario rewards, campaigns, JSON pack loading, and required JSON sidecar docs.
